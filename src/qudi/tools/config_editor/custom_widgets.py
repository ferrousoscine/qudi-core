...
__all__ = ["CustomConnectorsWidget", "CustomItemsWidget", "CustomOptionsWidget"]
...
class CustomItemsWidget(QtWidgets.QWidget):
    ...
    def __init__(
        ...
        icons_dir = Path(get_artwork_dir()) / "icons"
        self.add_item_button = QtWidgets.QToolButton()
        self.add_item_button.setIcon(QtGui.QIcon(str(icons_dir / "list-add")))
        ...
        self._remove_icon = QtGui.QIcon(str(icons_dir / "list-remove"))
